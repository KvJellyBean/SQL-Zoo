...
-- 2. How to use WHERE to filter records. Show the name for the countries that have a population 
...
-- Show the name, population and area for countries with an area of at least 3 million or a population of at least 250 million but not both.
SELECT name, population, area
FROM world
